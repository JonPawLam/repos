...
namespace France_Vacancis_1_sem__projeck_vJon0._1.Model
{
    class LejlighederModel
    {
        ...
        //                  Construktor
        public LejlighederModel(int lejlighedId, string lejlighedName, double lejlighedPris, string land, string lejlighedInfo, int l1EjlighedKvm)
        {
